...
resource "google_workstations_workstation_config" "nc" {
  ...
  workstation_cluster_id = google_workstations_workstation_cluster.nc.workstation_cluster_id
  location                    = "us-central1"
...
resource "google_workstations_workstation" "nc" {
  ...
  workstation_config_id  = google_workstations_workstation_config.nc.workstation_config_id
  workstation_cluster_id = google_workstations_workstation_cluster.nc.workstation_cluster_id
  location                    = "us-central1"
